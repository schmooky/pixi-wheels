...
| Knob | Feel | Try |
|---|---|---|
| `elasticity` | how far past the minimum it is thrown | `1` exactly enough, `1.4` flings it. Under 1 is clamped: less than the geometry is a blade drawn through a peg |
| `friction` | how much the peg drags it: a fatter peg, held longer | `0` lets go at once, `1` hangs on a long way |
