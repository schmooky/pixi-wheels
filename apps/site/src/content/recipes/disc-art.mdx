...
This is the long version: what the layers are, what each asset has to match, and where a real game's art ends up. The tongue has [its own recipe](/recipes/tongue/).
...
<Image src="/recipes/disc-art/layers.svg" alt="Seven stacked layers: face, plates, dividers and pegs, labels, bezel, hub, pointer" caption="Draw order from the bottom. The first four turn with the disc; the rest sit on the fixed overlay." />
...
<Image src="/recipes/disc-art/face-template.svg" alt="A square canvas with the disc inscribed, the centre marked, zero degrees at three o'clock and the section 0 edge in gold" caption="The six things a face texture has to get right." />
...
<Image src="/recipes/disc-art/plate-template.svg" alt="A plate sprite in its own box with the anchor at the centre and the outward direction marked, and the same plate fanned around a wheel" caption="Author the plate upright with its outward edge at the top; the engine rotates it into place." />
...
<Image src="/recipes/disc-art/label-slot.svg" alt="A wedge with the chord at the label radius marked and the slot box a label is fitted into" caption="labelSlot gives you the box; fitContainer scales anything into it." />
...
<Image src="/recipes/disc-art/atlas.svg" alt="Three atlas cases side by side: packed as drawn, trimmed, and rotated ninety degrees" caption="All three are normal. All three break the pivot if you read the rectangle and stop there." />
