...
- Stutter: a leg to a halt a hair inside the bait, a beat, a push over the line.
- Overshoot: a leg a few degrees past the line into the bait, a beat, a soft roll back to a rest just inside the landing section.
