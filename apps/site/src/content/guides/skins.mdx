...
Every layer of art a disc is made of, with the size, pivot and orientation each one has to match, is in the [disc recipe](/recipes/disc-art/); the pointer has [its own](/recipes/tongue/).
