...
**Anticipation**: a planned near-miss. The pointer heads for the bait and lands on the target. `anticipation:start`, `anticipation:bait`, `anticipation:end`. [Anticipation](/guides/anticipation/)
...
**Creep**: the pointer crawls past the bait and stops one section later.

**Overshoot**: the pointer runs into the bait, stops, and rolls back onto the target.

**Stutter**: the pointer twitches at the bait before finishing.
